  function IconShow(size = 46) {
    ...
    const iconSlots = document.querySelectorAll('.icon');
...
// ABOVE IS A CLUE TO WHAT IS HAPENIN IN THIS MAIN CODE.
const reviewElements = document.querySelectorAll(".review"); //  THE SAME THING THAT HAPENS ABOVE, DOCUMENT METHOD(queryselectorAll()) 
